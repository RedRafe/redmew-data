...
data:extend({
    -- Item
    {
        name = cp2.name,
        type = 'item',
        icons = redmew.reskin_library.make_item_icons('chemical-plant', cp2._tint),
...
data:extend({
    -- Item
    {
        name = or2.name,
        type = 'item',
        icons = redmew.reskin_library.make_item_icons('oil-refinery', or2._tint),
        order = 'd[refinery]',
...
data:extend({
    -- Item
    {
        name = or3.name,
        type = 'item',
        icons = redmew.reskin_library.make_item_icons('oil-refinery', or3._tint),
        order = 'd[refinery]',
...
data:extend({
    {
        ...
        icons = redmew.reskin_library.make_technology_icons('oil-gathering', cp2._tint),
