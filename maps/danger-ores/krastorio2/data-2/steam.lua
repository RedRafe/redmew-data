...
data:extend({
    -- Item
    {
        name = bo2.name,
        type = 'item',
        icons = redmew.reskin_library.make_item_icons('boiler', bo2._tint),
...
data:extend({
    -- Item
    {
        name = se2.name,
        type = 'item',
        icons = redmew.reskin_library.make_item_icons('steam-engine', se2._tint),
...
data:extend({
    {
        type = 'technology',
        name = 'steam-power-2',
        icons = redmew.reskin_library.make_technology_icons('steam-power', se2._tint),
