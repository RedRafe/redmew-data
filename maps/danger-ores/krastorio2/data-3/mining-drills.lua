...
data:extend({
    -- Item
    {
        name = emd4.name,
        type = 'item',
        icons = redmew.reskin_library.make_item_icons('electric-mining-drill', emd4._tint),
    ...
    -- Technology
    {
        type = 'technology',
        name = emd4.name,
        icons = redmew.reskin_library.make_technology_icons('electric-mining-drill', emd4._tint),
