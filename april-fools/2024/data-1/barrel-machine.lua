...
data:extend({
  ...
  -- Entity
  {
    ...
    animation = make_4way_animation_from_spritesheet({
      layers = {
        {
          filename = '__redmew-data__/graphics/entity/barrel-machine/barrel-machine.png',
          width = 122,
          height = 134,
          frame_count = 1,
        ...
        {
          filename = '__redmew-data__/graphics/entity/barrel-machine/barrel-machine-shadow.png',
          width = 156,
          height = 141,
          frame_count = 1,
    ...
    working_visualisations = {
      {
        ...
        animation = {
          filename = '__redmew-data__/graphics/entity/barrel-machine/boiling-green-patch.png',
          frame_count = 32,
          width = 15,
          height = 10,
          animation_speed = 0.5,
      ...
      },
      {
        ...
        animation = {
          filename = '__redmew-data__/graphics/entity/barrel-machine/boiling-green-patch-mask.png',
          frame_count = 32,
          width = 15,
          height = 10,
          animation_speed = 0.5,
      ...
      },
      {
        ...
        east_position = { 0, 0 },
        north_animation = {
          filename = '__redmew-data__/graphics/entity/barrel-machine/boiling-window-green-patch.png',
          frame_count = 1,
          width = 87,
          height = 60,
    ...
    crafting_speed = 1,
    energy_source = { type = 'electric', usage_priority = 'secondary-input', emissions_per_minute = 10 },
    energy_usage = '250kW',
