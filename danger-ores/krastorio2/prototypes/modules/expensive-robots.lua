local robot_energy_multipler = settings.startup["k2-danger-ores:robot_energy_multipler"].value

if settings.startup['k2-danger-ores:robot_energy_multipler_include_construction_robots'].value then
